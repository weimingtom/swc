...
void CWinFrame::OnviewSourceView(WPARAM wParam, LPARAM lParam, HWND hWnd)
{
	ShowFloatWindow(m_TreeResource.GetParent());
}

void CWinFrame::OnViewHelp(WPARAM wParam, LPARAM lParam, HWND hWnd)
{
	/*ShowFloatWindow( m_TreeHelp.GetParent());*/
}

void CWinFrame::OnViewToolbox(WPARAM wParam, LPARAM lParam, HWND hWnd)
{
	ShowFloatWindow(m_explorer.GetParent());
}

void CWinFrame::OnViewClassView(WPARAM wParam, LPARAM lParam, HWND hWnd)
{
	ShowFloatWindow(m_TreeClassView.GetParent());
}

void CWinFrame::OnOutlook(WPARAM wParam, LPARAM lParam, HWND hWnd)
{
	ShowFloatWindow( m_explorer.GetParent());
}

void CWinFrame::OnSolutionExplorer(WPARAM wParam, LPARAM lParam, HWND hWnd)
{
	ShowFloatWindow(m_explorer.GetParent());
}

void CWinFrame::OnWorTabdemo(WPARAM wParam, LPARAM lParam, HWND hWnd)
{
	ShowFloatWindow(m_WorkTab.GetParent());
}
...
{	
	...
	CRect temp1(0,0,0,0);
	if (!cf.Create( &m_rtab, temp1,WS_CHILD|WS_VISIBLE, 1000))
		return -1;
