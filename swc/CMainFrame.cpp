...
int CMainFrame::OnCreate(LPCREATESTRUCT lpCreateStruct)
{
	...
	CRect temp1(0,0,0,0);
	if (!cmedBottom.Create( &splitterMain, temp1, WS_CHILD, 1000))
		return -1;
	CRect temp2(0,0,0,0);
	if (!cmedLeft.Create( &splitterLeft, temp2, WS_CHILD, 1001))
		return -1;

	CRect temp3(0,0,0,0);
	if (!cmedRight.Create( &splitterCenter, temp3,WS_CHILD, 1002))
		return -1;
