...
BEGIN_MSG_MAP()
	 ...
	 ON_COMMAND(ID_FILE_NEW_PWC,OnNew)
	 ON_COMMAND(ID_FILE_CLOSE_PWC,OnFileClose)
	 ON_COMMAND(ID_FILE_OPEN_PWC,OnFileOpen)
	 ON_WM_SIZE(OnSize) 
	 ON_COMMAND(ID_TOOLBAR_PWC,OnToolBar)
	 ON_COMMAND(IDM_EXIT_PWC,OnExit)
	 ON_COMMAND(IDM_ABOUT_PWC,OnAbout)

	 ON_COMMAND(ID_VIEWRESOURCEVIEW_PWC,OnviewSourceView)
	 ON_COMMAND(ID_VIEWHELPWINDOW_PWC,OnViewHelp)
	 ON_COMMAND(ID_VIEWTOOLBOX_PWC,OnViewToolbox)
	 ON_COMMAND(ID_VIEWCLASSVIEW_PWC,OnViewClassView)
	 ON_COMMAND(ID_VIEW_OUTLOOKWINDOW_PWC,OnOutlook)
	 ON_COMMAND(ID_VIEW_SOLUTIONEXPLORER_PWC,OnSolutionExplorer)
	 ON_COMMAND(ID_VIEW_WORTABDEMO_PWC,OnWorTabdemo)
END_MSG_MAP(CFrame)
};
