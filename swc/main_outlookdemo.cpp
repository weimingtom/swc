...
BOOL CWinFrame::OnCreate(LPCREATESTRUCT lpCreateStruct)
{
	...
	CRect temp1 = CRect(0,0,0,0);
	if (!cf.Create( &m_Splitter, temp1,WS_CHILD|WS_VISIBLE, 1000))
		return -1;
	...
	CRect temp2 = CRect(0,0,0,0);
	if (!out2.Create(WS_VISIBLE,
		temp2, &cf, 1))
		return -1;
		
	CRect temp3 = CRect(0,0,0,0);
